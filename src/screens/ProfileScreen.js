...
export default function ProfileScreen() {
  ...
  const currentLeagueImage = leagueImages[userProfile.currentLeague] || leagueImages.default;
      ...
      <View style={styles.mainContainer}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.socialSection}>
            ...
            <TouchableOpacity onPress={copyToClipboard} style={styles.myCodeBox}>
              <Text style={styles.codeText}>{userProfile.friendCode}</Text>
              <Ionicons name="copy-outline" size={20} color="#555" style={{marginLeft: 10}}/>
            </TouchableOpacity>
            ...
            <View style={styles.searchBox}>
              <TextInput
                ...
                maxLength={6}
              />
              <TouchableOpacity style={styles.searchBtn} onPress={handleSearchFriend}>
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <Text style={styles.settingSubtext}>Tes roasts seront visible dans le Feed.</Text>
